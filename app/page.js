  ...
  return (
    <main className="h-screen">
      ...
      <ul>
        ...
        <li><Link className={LinkStyle} href="./week-7">week-7</Link></li>
        <li><Link className={LinkStyle} href="./week-8">week-8</Link></li>
        <li><Link className={LinkStyle} href="./week-10">week-10</Link></li>
      </ul>
    </main>
  );
}
